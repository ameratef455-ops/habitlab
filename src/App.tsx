    ...
    <div className="min-h-screen bg-[#fafafa] text-slate-900 font-sans selection:bg-indigo-500 selection:text-white transition-all duration-700 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800/50 h-16 flex items-center">
        <div className="max-w-2xl mx-auto w-full px-10 sm:px-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
             {activeTab !== 'habits' ? (
                <button 
                  ...
                  className="w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-indigo-50 transition-all"
                >
          ...
          <div className="flex p-1 bg-slate-100 rounded-2xl border border-slate-200 relative">
          ...
          <div className="flex items-center gap-2">
             ...
             >
                <Zap className={`w-4 h-4 ${globalRecoveryMode ? 'fill-current' : ''}`} />
             </button>
             <div className="relative">
               <button 
                 onClick={() => setShowSettings(!showSettings)}
                 className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all shadow-sm ${showSettings ? 'bg-indigo-500 text-white shadow-indigo-500/20' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
               >
                 ...
                 {showSettings && (
                   <>
                     ...
                     <motion.div 
                       ...
                       className="absolute top-full left-0 mt-2 w-48 bg-white rounded-2xl shadow-2xl border border-slate-100 p-2 z-[60] origin-top-left"
                     >
                       <button 
                         onClick={() => {
                           setShowSupport(true);
                         ...
                         className="w-full text-right px-4 py-2 hover:bg-slate-50 rounded-xl text-[10px] font-black text-amber-500"
                       >
                         ادعم المشروع ☕
                       </button>
                       <button 
                         ...
                         className="w-full text-right px-4 py-2 hover:bg-slate-50 rounded-xl text-[10px] font-black text-slate-600"
                       >
                         تصدير الداتا 💾
                       </button>
                       <label className="w-full text-right px-4 py-2 hover:bg-slate-50 rounded-xl text-[10px] font-black text-slate-600 cursor-pointer block">
                          استيراد الداتا 📁
                       ...
                       <button 
                         ...
                         className="w-full text-right px-4 py-2 hover:bg-slate-50 hover:scale-[1.02] active:scale-[0.98] transition-all rounded-xl text-[10px] font-black text-indigo-500"
                       >
                         English PDF Report 📄
                       </button>
                       <button 
                         ...
                         className="w-full text-right px-4 py-2 hover:bg-slate-50 rounded-xl text-[10px] font-black text-emerald-500"
                       >
                         تثبيت التطبيق 📱
                       </button>
                     </motion.div>
